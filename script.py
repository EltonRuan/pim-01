...
def show_data_product(key, value):
    ...
    result = product_data[0] + ", " + product_data[1] + ", " + product_data[2] + ", " + product_data[3] + ", " + product_data[4] + ", " + product_data[5] + ", " + product_data[6]
...
def calculate_total_stock(products):
    ...
    for name, product in products.items():
        ...
        # verifica o mais caro, por unidade
        if value_unit > highest_value:
            highest_value = value_unit
            most_expensive_product = name

        # verifica o mais barato, por unidade
        if lowest_value == 0 or value_unit < lowest_value:
            lowest_value = value_unit
            cheapest_product = name

    return total_quantity, total_weight, total_value, most_expensive_product, highest_value, cheapest_product, lowest_value
...
# se o login for bem-sucedido, ele retorna os dados de todas as funções
    ...
    while True:
        ...
        # exibe o menu de opções para o usuário escolher qual informação deseja acessar, e chama a função correspondente à opção escolhida
        ...
        # dependendo da opção escolhida, ele chama a função correspondente e exibe os resultados
        if options == "1":
            ...
            total_quantity, total_weight, total_value, most_expensive, highest_value, cheapest, lowest_value = calculate_total_stock(all_stock_products)
            ...
            print(f"Produto mais caro: {most_expensive} - Valor total: R$ {highest_value:.2f}")
            print(f"Produto mais barato: {cheapest} - Valor total: R$ {lowest_value:.2f}")
            print("\n")
